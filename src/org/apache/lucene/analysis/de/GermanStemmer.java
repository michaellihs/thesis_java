 ...
 * "A Fast and Simple Stemming Algorithm for German Words" by Jšrg
 * Caumanns (joerg.caumanns@isst.fhg.de).
 * 
 * Implementation has been taken from http://alvinalexander.com/java/jwarehouse/lucene-1.3-final/src/java/org/apache/lucene/analysis/de/GermanStemmer.java.shtml
 *
 * @author    Gerhard Schwarz
 * @version   $Id: GermanStemmer.java,v 1.11 2004/05/30 20:24:20 otis Exp $
 * @see de.mknoll.thesis.tests.algorithms.GermanStemmerTest
 */
public class GermanStemmer implements Stemmer
{
     ...
     *
     * - Substitute Umlauts with their corresponding vowel: ŠšŸ -> aou,
    ...
    private void substitute( StringBuffer buffer )
    {
      ...
      for ( int c = 0; c < buffer.length(); c++ ) {
        ...
        // Substitute Umlauts.
        else if ( buffer.charAt( c ) == 'Š' ) {
          buffer.setCharAt( c, 'a' );
        }
        else if ( buffer.charAt( c ) == 'š' ) {
          buffer.setCharAt( c, 'o' );
        }
        else if ( buffer.charAt( c ) == 'Ÿ' ) {
